...
def lambda_handler(event, context):
  try:
    ...
    sql = """ UPDATE jobs set status='completed', resultsfilekey=%s where jobid=%s """;
  ...
  #
    ...
    sql = """ UPDATE jobs set status='error', resultsfilekey=%s where jobid=%s """;
    
    datatier.perform_action(dbConn, sql, [local_results_file,jobid])
